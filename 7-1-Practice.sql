...
select * from personel
where email not like '%gmail%' ; -- neden null e getirmedi % ile arama yaptigimiz icin null gelmez.

-- 11) id'si 3,5,7 ve 9 olan personel bilgilerini listeleyiniz.
select * from personel where id in(3,5,7,9) ; -- 2. yol
...
select * from personel where between yas<30 or yas>40 ;
...
select * from personel order by yas ; --dogal seralamasi kucukten buyuge asc
...
select * from personel order by maas limit 3 ; -- sondan 3 :)
