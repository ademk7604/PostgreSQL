...
select * from kisiler ORDER BY adres -- kalici hale gelmiyor tabi
...
select * from kisiler ORDER BY adres desc; -- DESCENDING (DESC) tersten siralama yapacagimiz zaman kullaniriz (azalan)

-- kisiler tablosunda maasi buyuten buyuge siralayiniz
