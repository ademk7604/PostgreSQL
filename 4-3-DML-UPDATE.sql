...
UPDATE tedarikciler
SET firma_ismi = 'Vestel' WHERE vergi_no=102 -- set ayarla.vergi nosunu 102 olan firmanin ismini vestel olarak SET (ayarla)
-- vergi_no’su 101 olan tedarikçinin firma ismini 'casper' ve irtibat_ismi’ni 'Ali Veli' olarak güncelleyiniz.
UPDATE tedarikciler
SET firma_ismi = 'Caper', irtibat_ismi='Ali Veli' WHERE vergi_no=101
--  urunler tablosundaki 'Phone' değerlerini 'Telefon' olarak güncelleyiniz.
UPDATE urunler
SET urun_isim = 'TELEFON' WHERE ted_vergino=102
UPDATE urunler
