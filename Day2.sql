...
--Soru : ismi Kemal Yasar olan satiri siliniz.
...
--soru : ismi ali Can id 123 olan kaydi siliniz
...
--(hoca personel verilerini buraya yapistirip calistirdi)
select * from personel;
alter table personel add cinsiyet varchar(20), add yas int;

-- personel tablosunda sirket field'ini siliniz
...
--alter table personel guncelle olarak RENAME column sehir to ulke; degistir.
